...
```
$ docker image tag invoice hussam/invoice
$ docker push hussam/invoice
$ docker image tag notification hussam/notification
$ docker push hussam/notification
$ docker image tag store hussam/store
$ docker push hussam/store
```
...
```
$ kubectl get svc store -n hussam
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n hussam
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n hussam
```
...
```
$ kubectl get svc jhipster-console -n hussam
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n hussam
```

and explore the details using

```
$ kubectl get svc exposed-registry -n hussam
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n hussam
```
