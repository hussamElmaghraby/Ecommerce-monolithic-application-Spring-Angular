package com.ecommerce.hussam.config;
...
@Configuration
@EnableMongoRepositories("com.ecommerce.hussam.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.ecommerce.hussam.config.dbmigrations");
